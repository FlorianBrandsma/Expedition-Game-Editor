...
public class NotificationSegment : MonoBehaviour, ISegment
{
    ...
    public void InitializeData()
    {
        ...
        var searchProperties = new SearchProperties(Enums.DataType.Notification);
    ...
    private void InitializeSearchParameters(SearchProperties searchProperties)
    {
        ...
        searchParameters.notificationType = notificationType;
    }
