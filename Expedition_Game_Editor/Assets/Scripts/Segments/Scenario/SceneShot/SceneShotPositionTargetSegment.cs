...
public class SceneShotPositionTargetSegment : MonoBehaviour, ISegment
{
    ...
    private int PositionTargetSceneActorId
    {
        ...
        set { SceneShotEditor.PositionTargetSceneActorId = value; }
    }
    ...
    private void InitializeSceneButton()
    {
        ...
        searchParameters.id = new List<int>() { PositionTargetSceneActorId };
        ...
        sceneActorElementData.DataElement.Id = PositionTargetSceneActorId;
