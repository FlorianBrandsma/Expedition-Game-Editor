...
public class ChapterGeneralWorldInteractableSegment : MonoBehaviour, ISegment
{
    ...
    public void InitializeData()
    {
        ...
        var chapterInteractableList = SegmentController.DataController.DataList.Cast<WorldInteractableDataElement>().ToList();
        chapterInteractableList.ForEach(x => ChapterEditor.worldInteractableDataList.Add(x));
    }
