...
{
    public TaskElementData TaskData { get { return (TaskElementData)Data.elementData; } }
    ...
    {
        get { return SelectionElementManager.FindElementData(TaskData).Concat(new[] { TaskData }).Distinct().ToList(); }
    }
