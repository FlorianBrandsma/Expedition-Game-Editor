...
public class ChapterDataController : MonoBehaviour, IDataController
{
    ...
    public void GetData(SearchProperties searchProperties)
    {
        ...
        {
            dataController = this,
            dataList = ChapterDataManager.GetData(searchProperties.searchParameters.Cast<Search.Chapter>().First()),
