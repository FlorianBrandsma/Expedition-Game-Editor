...
public class QuestSaveDataController : MonoBehaviour, IDataController
{
    ...
    public void GetData(SearchProperties searchProperties)
    {
        ...
        {
            dataController = this,
            dataList = QuestSaveDataManager.GetData(searchProperties.searchParameters.Cast<Search.QuestSave>().First()),
