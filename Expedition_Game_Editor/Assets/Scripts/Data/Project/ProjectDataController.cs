...
public class ProjectDataController : MonoBehaviour, IDataController
{
    ...
    public void GetData(SearchProperties searchProperties)
    {
        ...
        {
            dataController = this,
            dataList = ProjectDataManager.GetData(searchProperties.searchParameters.Cast<Search.Project>().First()),
