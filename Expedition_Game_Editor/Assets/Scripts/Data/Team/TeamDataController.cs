...
public class TeamDataController : MonoBehaviour, IDataController
{
    ...
    public void GetData(SearchProperties searchProperties)
    {
        ...
        {
            dataController = this,
            dataList = TeamDataManager.GetData(searchProperties.searchParameters.Cast<Search.Team>().First()),
