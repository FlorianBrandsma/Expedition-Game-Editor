...
public class PhaseSaveDataController : MonoBehaviour, IDataController
{
    ...
    public void GetData(SearchProperties searchProperties)
    {
        ...
        {
            dataController = this,
            dataList = PhaseSaveDataManager.GetData(searchProperties.searchParameters.Cast<Search.PhaseSave>().First()),
