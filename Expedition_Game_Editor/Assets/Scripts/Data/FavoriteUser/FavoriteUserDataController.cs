...
public class FavoriteUserDataController : MonoBehaviour, IDataController
{
    ...
    public void GetData(SearchProperties searchProperties)
    {
        ...
        {
            dataController = this,
            dataList = FavoriteUserDataManager.GetData(searchProperties.searchParameters.Cast<Search.FavoriteUser>().First()),
