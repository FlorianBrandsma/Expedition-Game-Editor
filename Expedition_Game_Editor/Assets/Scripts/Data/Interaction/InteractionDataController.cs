...
public class InteractionDataController : MonoBehaviour, IDataController
{
    ...
    public void GetData(SearchProperties searchProperties)
    {
        ...
        {
            dataController = this,
            dataList = InteractionDataManager.GetData(searchProperties.searchParameters.Cast<Search.Interaction>().First()),
