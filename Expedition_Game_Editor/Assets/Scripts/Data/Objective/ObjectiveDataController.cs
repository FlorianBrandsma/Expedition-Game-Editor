...
public class ObjectiveDataController : MonoBehaviour, IDataController
{
    ...
    public void GetData(SearchProperties searchProperties)
    {
        ...
        {
            dataController = this,
            dataList = ObjectiveDataManager.GetData(searchProperties.searchParameters.Cast<Search.Objective>().First()),
