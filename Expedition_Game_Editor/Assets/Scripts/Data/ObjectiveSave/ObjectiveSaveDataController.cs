...
public class ObjectiveSaveDataController : MonoBehaviour, IDataController
{
    ...
    public void GetData(SearchProperties searchProperties)
    {
        ...
        {
            dataController = this,
            dataList = ObjectiveSaveDataManager.GetData(searchProperties.searchParameters.Cast<Search.ObjectiveSave>().First()),
